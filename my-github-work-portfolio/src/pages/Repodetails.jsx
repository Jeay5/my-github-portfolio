...
function RepoDetails() {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/jeay5/${id}`)
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/jeay5/${id}/branches`)
    .then((response) => (response.json()))
    .then((data) => {
      setBranch(data)
    })
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/jeay5/${id}/deployments`)
    .then((response) => (response.json()))
    .then((data) => {
      setDeployment(data)
    })
    ...
    return (
        <div id="repodetail">
            <div className="repodetail-card">
                ...
                <p>Live site: {deployment.length === 0 ? `none` : <a href={`https://jeay5.github.io/${details.name}`}>jeay5.github.io/{details.name}</a>}</p>
